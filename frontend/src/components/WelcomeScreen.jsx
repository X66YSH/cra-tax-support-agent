import { Calculator, Gift, Bell, CalendarCheck, Landmark } from 'lucide-react';
...
export default function WelcomeScreen({ onSuggestion, dark }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-6">
      {/* Logo */}
      <div className="bot-avatar w-16 h-16 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
